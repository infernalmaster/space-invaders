...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["game", "game.dart", , Q, {
  "^": "",
  Bullet: {
    "^": "GameEntity;game,size,center,velocity"
  },
  GameEntity: {
    "^": "Object;center<",
    update$0: function() {
      this.center.add$1(0, this.velocity);
    }
  },
  Game: {
    "^": "Object;canvas,ctx,size,bodies,bodiesNew,keyboarder,shaker",
    createInvaders$0: function() {
      var invaders, i, t1, t2, t3;
      invaders = [];
      for (i = 0; i < 24; ++i) {
        t1 = C.JSInt_methods.$mod(i, 8);
        ...
        t2[0] = 0.3;
        t2[1] = 0;
        invaders.push(new Q.Invader(0, this, new T.Vector2(t1), new T.Vector2(t3), new T.Vector2(t2)));
      }
      return invaders;
    },
    areAnyInvadersBelow$1: function(invader) {
      var t1 = {};
      t1.isBelow_0 = false;
      C.JSArray_methods.forEach$1(this.bodies, new Q.Game_areAnyInvadersBelow_closure(t1, invader));
      return t1.isBelow_0;
    },
    _tick$1: [function(highResTime) {
      var t1, t2;
      this.update$0();
      this.draw$0();
      t1 = window;
    ...
    }, "call$1", "get$_tick", 2, 0, 20],
    update$0: function() {
      H.IterableMixinWorkaround_removeWhereList(this.bodies, new Q.Game_update_closure(this));
      var t1 = this.getNonCollidingBodies$0();
      this.bodies = t1;
      C.JSArray_methods.forEach$1(t1, new Q.Game_update_closure0());
      C.JSArray_methods.addAll$1(this.bodies, this.bodiesNew);
      this.bodiesNew = [];
    },
    draw$0: function() {
      var t1, t2;
      ...
      t1.clearRect(0, 0, t2[0], t2[1]);
      C.JSArray_methods.forEach$1(this.bodies, new Q.Game_draw_closure(this));
      t2 = this.ctx;
      t1 = "bodeis in game: " + this.bodies.length;
      t2.toString;
      t2.fillText(t1, 5, 10);
    },
    getNonCollidingBodies$0: function() {
      var notCollidingBodies, t1, b1, notColliding, t2, t3, b2, t4, t5, t6, t7, t8, t9, t10, t11;
      notCollidingBodies = [];
      for (t1 = this.bodies, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
        b1 = t1._current;
        t2 = this.bodies;
        t2 = new H.ListIterator(t2, t2.length, 0, null);
        t3 = J.getInterceptor(b1);
        while (true) {
          if (!t2.moveNext$0()) {
            notColliding = true;
            break;
          ...
          b2 = t2._current;
          if (!t3.$eq(b1, b2)) {
            t4 = b1.get$center().storage[0];
            t5 = b1.size.storage[0];
            t6 = b2.get$center().storage[0];
            t7 = b2.size.storage;
            t8 = t7[0] / 2;
            if (!(t4 + t5 / 2 < t6 - t8)) {
              t4 = b1.center.storage;
              t5 = t4[1];
              t6 = b1.size.storage;
              t9 = t6[1] / 2;
              t10 = b2.center.storage;
              t11 = t10[1];
              t7 = t7[1] / 2;
              t4 = t5 + t9 < t11 - t7 || t4[0] - t6[0] / 2 > t10[0] + t8 || t5 - t9 > t11 + t7;
            } else
              t4 = true;
          } else
            t4 = true;
    ...
    Game$0: function() {
      ...
      this.canvas = t1;
      this.ctx = J.get$context2D$x(t1);
      t1 = J.toDouble$0$n(J.get$width$x(this.canvas));
      t2 = J.toDouble$0$n(J.get$height$x(this.canvas));
      t3 = new Float32Array(H._checkLength(2));
      t3[0] = t1;
      t3[1] = t2;
      this.size = new T.Vector2(t3);
      t2 = this.bodies;
      t1 = t3[0];
      t3 = t3[1];
      ...
      t1[0] = 0;
      t1[1] = 0;
      t5 = new P.DateTime(Date.now(), false);
      t5.DateTime$_now$0();
      t2.push(new Q.Player(t5, 2, this, new T.Vector2(t3), new T.Vector2(t4), new T.Vector2(t1)));
      C.JSArray_methods.addAll$1(this.bodies, this.createInvaders$0());
      this.update$0();
      this.draw$0();
      t1 = window;
      t4 = this.get$_tick();
  ...
  Game_areAnyInvadersBelow_closure: {
    "^": "Closure:9;box_0,invader_1",
    call$1: function(body) {
      var t1;
      if (!!J.getInterceptor(body).$isInvader) {
        t1 = this.invader_1;
        t1 = body !== t1 && body.center.storage[1] > t1.center.storage[1];
      } else
        t1 = false;
      if (t1) {
        this.box_0.isBelow_0 = true;
        return;
      }
    },
    $isFunction: true
  ...
  Game_update_closure: {
    ...
    call$1: function(b) {
      var t1, t2, t3;
      if (!(b.get$center().storage[0] < 0)) {
        t1 = b.center.storage;
        t2 = t1[0];
        t3 = this.this_0.size.storage;
        if (!(t2 > t3[0])) {
          t1 = t1[1];
          t1 = t1 < 0 || t1 > t3[1];
        } else
  ...
  Game_draw_closure: {
    ...
    call$1: function(body) {
      var t1, t2, t3, t4, t5;
      t1 = this.this_0.ctx;
      t2 = body.get$center().storage[0];
      t3 = body.size.storage;
      t4 = t3[0];
      t5 = body.center.storage[1];
      t3 = t3[1];
      t1.fillRect(t2 - t4 / 2, t5 - t3 / 2, t4, t3);
    },
    $isFunction: true
  },
  Invader: {
    "^": "GameEntity;patrolX,game,size,center,velocity",
    update$0: function() {
      var t1, t2, t3, t4;
      t1 = this.patrolX;
      if (t1 < 0 || t1 > 30) {
      ...
      t2 = this.velocity;
      t1.add$1(0, t2);
      this.patrolX = this.patrolX + t2.storage[0];
      t2 = this.game;
      if (t2.shaker.nextInt$1(1000) > 995 && !t2.areAnyInvadersBelow$1(this)) {
        t3 = new T.Vector2(new Float32Array(H._checkLength(2)));
        t3.setFrom$1(t1);
        t1 = this.size.storage[1];
        t4 = new Float32Array(H._checkLength(2));
        t4[0] = 0;
        t4[1] = t1 / 2 + 2;
        t4 = t3.add$1(0, new T.Vector2(t4));
        t3 = new Float32Array(H._checkLength(2));
        t3[0] = 3;
        t3[1] = 3;
        t1 = new Float32Array(H._checkLength(2));
        t1[0] = 0;
        t1[1] = 2;
        t2.bodiesNew.push(new Q.Bullet(t2, new T.Vector2(t3), t4, new T.Vector2(t1)));
      }
    },
    $isInvader: true
  },
  Keyboarder: {
    "^": "Object;keyState,KEYS",
    _onKeyDown$1: [function(e) {
      this.keyState.add$1(0, J.get$keyCode$x(e));
    }, "call$1", "get$_onKeyDown", 2, 0, 21],
    _onKeyUp$1: [function(e) {
      this.keyState.remove$1(0, J.get$keyCode$x(e));
    }, "call$1", "get$_onKeyUp", 2, 0, 21],
    Keyboarder$0: function() {
      var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(this.get$_onKeyDown()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keyup", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(this.get$_onKeyUp()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }
  },
  Player: {
    "^": "GameEntity;lastBulletTime,maxVelocity,game,size,center,velocity",
    update$0: function() {
      var t1, t2, t3, t4, t5, t6, timeNow;
      t1 = this.center;
      t2 = t1.storage;
      t3 = t2[0];
      t4 = this.maxVelocity;
      ...
      t6 = t5.KEYS;
      t5 = t5.keyState;
      if (t5.contains$1(0, t6.$index(0, "LEFT")))
        t2[0] = t2[0] - t4;
      if (t5.contains$1(0, t6.$index(0, "RIGHT")))
        t2[0] = t2[0] + t4;
      t2 = Date.now();
      timeNow = new P.DateTime(t2, false);
      timeNow.DateTime$_now$0();
      if (t5.contains$1(0, t6.$index(0, "S")) && C.JSNumber_methods._tdivFast$1(P.Duration$(0, 0, 0, t2 - this.lastBulletTime.millisecondsSinceEpoch, 0, 0)._duration, 1000) > 100) {
        this.lastBulletTime = timeNow;
        ...
        t4[0] = 0;
        t4[1] = -t1 / 2 - 2;
        t4 = t2.add$1(0, new T.Vector2(t4));
        ...
        t1[0] = 0;
        t1[1] = -7;
        t3.bodiesNew.push(new Q.Bullet(t3, new T.Vector2(t2), t4, new T.Vector2(t1)));
      }
    }
  }
}],
["", "space_invaders.dart", , R, {
  "^": "",
  main: [function() {
    var t1 = new Q.Keyboarder(P.LinkedHashSet_LinkedHashSet(null, null, null, null), P.LinkedHashMap_LinkedHashMap$_literal(["LEFT", 37, "RIGHT", 39, "S", 83], null, null));
    t1.Keyboarder$0();
    new Q.Game(null, null, null, [], [], t1, C.C__JSRandom).Game$0();
...
//# sourceMappingURL=space_invaders.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function Bullet(game, size, center, velocity) {
    this.game = game;
    this.size = size;
    this.center = center;
  ...
  function GameEntity(center) {
    this.center = center;
  }
  GameEntity.builtin$cls = "GameEntity";
  if (!"name" in GameEntity)
    GameEntity.name = "GameEntity";
  $desc = $collectedClasses.GameEntity;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GameEntity.prototype = $desc;
  GameEntity.prototype.get$center = function() {
    return this.center;
  };
  function Game(canvas, ctx, size, bodies, bodiesNew, keyboarder, shaker) {
    this.canvas = canvas;
    this.ctx = ctx;
    this.size = size;
    this.bodies = bodies;
    this.bodiesNew = bodiesNew;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  function Game_areAnyInvadersBelow_closure(box_0, invader_1) {
    this.box_0 = box_0;
    this.invader_1 = invader_1;
  }
  Game_areAnyInvadersBelow_closure.builtin$cls = "Game_areAnyInvadersBelow_closure";
  if (!"name" in Game_areAnyInvadersBelow_closure)
    Game_areAnyInvadersBelow_closure.name = "Game_areAnyInvadersBelow_closure";
  $desc = $collectedClasses.Game_areAnyInvadersBelow_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_areAnyInvadersBelow_closure.prototype = $desc;
  function Game_update_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_update_closure.builtin$cls = "Game_update_closure";
  if (!"name" in Game_update_closure)
    Game_update_closure.name = "Game_update_closure";
  $desc = $collectedClasses.Game_update_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_update_closure.prototype = $desc;
  function Game_update_closure0() {
  }
  Game_update_closure0.builtin$cls = "Game_update_closure0";
  if (!"name" in Game_update_closure0)
    Game_update_closure0.name = "Game_update_closure0";
  $desc = $collectedClasses.Game_update_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_update_closure0.prototype = $desc;
  function Game_draw_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_draw_closure.builtin$cls = "Game_draw_closure";
  if (!"name" in Game_draw_closure)
    Game_draw_closure.name = "Game_draw_closure";
  $desc = $collectedClasses.Game_draw_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_draw_closure.prototype = $desc;
  function Invader(patrolX, game, size, center, velocity) {
  ...
  Invader.builtin$cls = "Invader";
  if (!"name" in Invader)
    Invader.name = "Invader";
  $desc = $collectedClasses.Invader;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Invader.prototype = $desc;
  function Keyboarder(keyState, KEYS) {
    this.keyState = keyState;
    this.KEYS = KEYS;
  }
  Keyboarder.builtin$cls = "Keyboarder";
  if (!"name" in Keyboarder)
    Keyboarder.name = "Keyboarder";
  $desc = $collectedClasses.Keyboarder;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyboarder.prototype = $desc;
  function Player(lastBulletTime, maxVelocity, game, size, center, velocity) {
